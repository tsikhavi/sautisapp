<section class="bg-slate-100 dark:bg-slate-900">
    <div class="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
        <div class="max-w-screen-md mb-8 lg:mb-16">
            <h2 class="mb-4 text-4xl font-extrabold text-slate-900 dark:text-slate-200">Designed for business teams like
                yours</h2>
            <p class="text-slate-500 sm:text-xl dark:text-slate-400">Here at Flowbite we focus on markets where
        ...
        <div class="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
            <div>
                <div
                    ...
                    <svg class="w-5 h-5 text-green-600 lg:w-6 lg:h-6 dark:text-green-300" fill="currentColor"
                ...
                <p class="text-slate-500 dark:text-slate-400">Plan it, create it, launch it. Collaborate seamlessly with
            ...
            <div>
                ...
                <p class="text-slate-500 dark:text-slate-400">Protect your organization, devices and stay compliant with
            ...
            <div>
                ...
                <p class="text-slate-500 dark:text-slate-400">Auto-assign tasks, send Slack messages, and much more. Now
            ...
            <div>
                ...
                <p class="text-slate-500 dark:text-slate-400">Audit-proof software built for critical financial
            ...
            <div>
                ...
                <p class="text-slate-500 dark:text-slate-400">Craft beautiful, delightful experiences for both marketing
            ...
            <div>
                ...
                <p class="text-slate-500 dark:text-slate-400">Keep your company’s lights on with customizable,
...
<section class="bg-slate-100 dark:bg-slate-900">
    <div class="gap-16 items-center py-8 px-4 mx-auto max-w-screen-xl lg:grid lg:grid-cols-2 lg:py-16 lg:px-6">
        <div class="font-light text-slate-500 sm:text-lg dark:text-slate-400">
            <h2 class="mb-4 text-4xl font-extrabold text-slate-900 dark:text-slate-200">We didn't reinvent the wheel
            </h2>
...
<section class="bg-slate-100  dark:bg-slate-900">
    <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
        <div class="max-w-screen-lg text-slate-500 sm:text-lg dark:text-slate-400">
            <h2 class="mb-4 text-4xl font-bold text-slate-900 dark:text-slate-200">Powering innovation at <span
            ...
            <a href="#"
                class="inline-flex items-center font-medium text-green-500 hover:text-green-800 dark:text-green-500 dark:hover:text-green-700">
                Learn more
