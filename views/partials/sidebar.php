<div class="flex flex-no-wrap">
    ...
    <div style="min-height: 716px" class="w-64 absolute sm:relative bg-slate-50 dark:bg-slate-950 shadow md:h-full flex-col 
        ...
        <div class="px-8">
            ...
            <div class="flex justify-center mt-48 mb-4 w-full">
                <div class="relative">
                    <div class="text-slate-300 absolute ml-4 inset-0 m-auto w-4 h-4">
                        <img src="https://tuk-cdn.s3.amazonaws.com/can-uploader/light_with_icons_at_bottom-svg2.svg"
                            alt="Search">
                    </div>
                    <input
                        class="dark:bg-slate-700 focus:outline-none focus:ring-1 focus:ring-slate-100 rounded w-full text-sm text-slate-300 placeholder-slate-400 bg-slate-100 pl-10 py-2"
                        type="text" placeholder="Search" />
                </div>
            </div>
        </div>
        <div class="px-8 border-t border-slate-700">
            <ul class="w-full flex items-center justify-between bg-slate-100 dark:bg-slate-950">
                <li class="cursor-pointer text-white pt-5 pb-3">
                    <button aria-label="show notifications"
                        class="focus:outline-none focus:ring-2 rounded focus:ring-slate-300">
                ...
                <li class="cursor-pointer text-white pt-5 pb-3">
                    <button aria-label="open logs" class="focus:outline-none focus:ring-2 rounded focus:ring-slate-300">
    ...
    <div class="w-64 z-40 absolute bg-slate-100 dark:bg-slate-950 shadow md:h-full flex-col justify-between sm:hidden transition duration-150 ease-in-out"
        id="mobile-nav">
        <button aria-label="toggle sidebar" id="openSideBar"
            class="h-10 w-10 bg-slate-100 dark:bg-slate-950 absolute right-0 mt-16 -mr-10 flex items-center shadow rounded-tr rounded-br justify-center cursor-pointer focus:outline-none focus:ring-2 focus:ring-offset-2 rounded focus:ring-slate-800"
        ...
        <button aria-label="Close sidebar" id="closeSideBar"
            class="hidden h-10 w-10 bg-slate-100 dark:bg-slate-950 absolute right-0 mt-16 -mr-10 items-center shadow rounded-tr rounded-br justify-center cursor-pointer text-white"
